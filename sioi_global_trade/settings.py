"""
Django settings for sioi_global_trade project.
...
ROOT_URLCONF = 'sioi_global_trade.urls'
...
DATABASES = {
    'default': {
        ...
        'NAME': config('dbname', default='postgres', cast=str),
        'USER': config('user', default='postgres', cast=str),
...
SWAGGER_SETTINGS = {
   'SECURITY_DEFINITIONS': {
      'Bearer': {
            ...
            'name': 'Authorization',
            'in': 'header',
            'description': 'JWT Authorization header using the Bearer scheme. Example: `JWT <Your_Token_Here>`'
      }
   }
}